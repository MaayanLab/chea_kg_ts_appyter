...
## Citing ChEA-KG-TS
Please acknowledge ChEA-KG-TS in your publications by citing the following reference:</span><br>Byrd AI, Evangelista JE, Van Dusen A, Clarke DJB, Berrada M, Jenkins SL, Ma'ayan A. <a style='color: #81A1C1' href='https://doi.org/10.1093/nar/gkag508' rel='noopener noreferrer' target='_blank'>ChEA-KG and ChEA-KG-TS: a network-based transcription factor enrichment analysis tool with an accompanying time-series workflow</a>. Nucleic Acids Research (2026). doi:10.1093/nar/gkag508.
